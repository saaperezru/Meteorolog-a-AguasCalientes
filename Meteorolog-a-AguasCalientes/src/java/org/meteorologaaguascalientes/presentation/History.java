...
public class History extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			HashMap<String, AbstractVariableService> variablesServicesMap = ServicesFactory.getInstance().getVariablesServicesMap();
			if (variableName != null && variablesServicesMap.containsKey(variableName)) {
				AbstractVariableService entry = variablesServicesMap.get(variableName);
				
				List<SortedMap<Date, Double>> dataList;
				SortedMap<Date, Double> data;
				
				HistoricControl historyControl = new HistoricControl();
				dataList = historyControl.getData(entry);
